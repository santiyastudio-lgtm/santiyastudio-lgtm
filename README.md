...
Local-first AI products for Android, Windows, game launchers, and private automation workflows.
...
### [GTA5 RAGECOOP Launcher](https://github.com/santiyastudio-lgtm/gta5-ragecoop-launcher)

Windows launcher for GTA V RAGECOOP / RageCoop+ that shortens the path from setup to co-op play:

- installs and manages required launcher/mod files
- helps host a server and share connection details
- writes the needed mod config for a joining player
- focuses on practical Windows-first UX for fast multiplayer setup
...
Android Kotlin Jetpack Compose GGUF Google Local OpenClaw Termux Hermes Windows Rust Tauri React TypeScript Game Tools
